...
export const Contact = () => {
  return (
    <Box w="100%" py="70px" bg="#f0f0f0">
        ...
        <Box w="50%" p={10} margin="auto" bg="#ffffff" borderRadius="5px" mt="100px">
            <form>
                ...
                <Button ml="540px" type="submit" fontWeight="bold" mt={8} px={10} py={6} bg="#facf0f" colorScheme="#facf0f" color="black">SUBMIT</Button>
            </form>
        </Box>
    </Box>
  )
